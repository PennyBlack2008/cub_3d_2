...
/*   Updated: 2020/11/11 16:33:42 by jikang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					get_color_tex(int i, int j, t_ray *r, 
		t_win *w)
{
	int				color;
	double			x;
	...
	color = w->map.curr_tex[r[i].wall_NSEW][(int)(w->tex[r[i].wall_NSEW].width * py + px)];

	return (color);
}

static void			draw_part_down(int i, double o_pjtd_height, 
		t_ray *r, t_win *w)
{
	int			j;
	int			color;
...
static void			draw_part_up(int i, double o_pjtd_height, 
		t_ray *r, t_win *w)
{
	int			k;
	int			color;
